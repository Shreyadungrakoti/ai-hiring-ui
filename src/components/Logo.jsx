export default function Logo({ size = 44 }) {
  return (
    ...
    >
      {/* Background with vibrant blue gradient */}
      <rect width="100" height="100" rx="16" fill="url(#logoGrad)" />
      
      {/* Resume/Document */}
      <rect x="25" y="20" width="50" height="60" rx="4" fill="white" />
      
      {/* Document lines - vibrant blue themed */}
      <line x1="32" y1="30" x2="60" y2="30" stroke="#5d9cff" strokeWidth="2.5" strokeLinecap="round" />
      ...
      {/* Checkmark circle - vibrant blue */}
      <circle cx="70" cy="70" r="18" fill="#5d9cff" />
      ...
      {/* Vibrant blue gradient definition */}
      <defs>
        <linearGradient id="logoGrad" x1="0" y1="0" x2="100" y2="100">
          <stop offset="0%" stopColor="#5d9cff" />
          <stop offset="50%" stopColor="#4a8fe2" />
          <stop offset="100%" stopColor="#3d7ed0" />
        </linearGradient>
      </defs>
    </svg>
  );
