export default function Logo({ size = 44 }) {
  return (
    ...
    >
      ...
      {/* Document lines - light blue themed */}
      <line x1="32" y1="30" x2="60" y2="30" stroke="#5b9cf5" strokeWidth="2.5" strokeLinecap="round" />
      ...
      {/* Checkmark circle - light blue */}
      <circle cx="70" cy="70" r="18" fill="#5b9cf5" />
      ...
      {/* Light blue gradient definition */}
      <defs>
