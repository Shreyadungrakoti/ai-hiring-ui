          ...
          <div className="landingShowcaseCard">
            <div className="landingShowcaseIllustration">
              <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="90" y="110" width="220" height="130" rx="4" fill="#5B8FF9" opacity="0.2"/>
                
                {/* Document icon */}
                <rect x="140" y="140" width="60" height="80" rx="4" fill="#ffffff"/>
                <line x1="150" y1="155" x2="190" y2="155" stroke="#5B8FF9" strokeWidth="3" strokeLinecap="round"/>
                ...
                {/* Plus icon - Blue */}
                <circle cx="240" cy="180" r="20" fill="#5B8FF9"/>
                ...
                {/* Sparkles - Blue */}
                <circle cx="120" cy="120" r="3" fill="#5B8FF9" opacity="0.8"/>
                <circle cx="280" cy="130" r="3" fill="#5B8FF9" opacity="0.8"/>
                <circle cx="270" cy="220" r="3" fill="#5B8FF9" opacity="0.8"/>
          ...
          <div className="landingShowcaseCard">
            <div className="landingShowcaseIllustration">
              <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Robot head */}
                <rect x="150" y="80" width="100" height="90" rx="12" fill="#5B8FF9"/>
                ...
                {/* Antenna */}
                <line x1="200" y1="80" x2="200" y2="60" stroke="#5B8FF9" strokeWidth="4" strokeLinecap="round"/>
                <circle cx="200" cy="55" r="6" fill="#5B8FF9">
                ...
                {/* Scan lines - Blue */}
                <line x1="50" y1="175" x2="350" y2="175" stroke="#5B8FF9" strokeWidth="2" opacity="0.6">
          ...
          <div className="landingShowcaseCard">
            <div className="landingShowcaseIllustration">
              <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Podium - Blue shades */}
                <rect x="160" y="140" width="80" height="100" fill="#5B8FF9" opacity="0.3"/>
                <rect x="90" y="170" width="80" height="70" fill="#5B8FF9" opacity="0.3"/>
                <rect x="230" y="190" width="80" height="50" fill="#5B8FF9" opacity="0.3"/>
                
                {/* Top candidates - All blue */}
                <circle cx="200" cy="120" r="20" fill="#5B8FF9"/>
                <text x="200" y="128" textAnchor="middle" fill="#ffffff" fontSize="20" fontWeight="bold">1</text>
                
                <circle cx="130" cy="150" r="18" fill="#5B8FF9"/>
                <text x="130" y="157" textAnchor="middle" fill="#ffffff" fontSize="18" fontWeight="bold">2</text>
                
                <circle cx="270" cy="170" r="16" fill="#5B8FF9"/>
                <text x="270" y="177" textAnchor="middle" fill="#ffffff" fontSize="16" fontWeight="bold">3</text>
                
                {/* Checkmarks - Blue */}
                <path d="M 185 115 L 195 125 L 215 105" stroke="#5B8FF9" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                
                {/* Stars - Blue */}
                <g transform="translate(175, 90)">
                  <path d="M 12.5 0 L 15 10 L 25 10 L 17 16 L 20 26 L 12.5 20 L 5 26 L 8 16 L 0 10 L 10 10 Z" fill="#5B8FF9"/>
                </g>
                ...
                {/* Trophy - Blue */}
                <path d="M 190 250 L 180 265 L 220 265 L 210 250 Z" fill="#5B8FF9"/>
                <rect x="195" y="245" width="10" height="15" fill="#5B8FF9"/>
                <ellipse cx="200" cy="240" rx="15" ry="12" fill="#5B8FF9"/>
                <path d="M 185 240 Q 175 235 175 225 L 180 230" stroke="#5B8FF9" strokeWidth="3" fill="none"/>
                <path d="M 215 240 Q 225 235 225 225 L 220 230" stroke="#5B8FF9" strokeWidth="3" fill="none"/>
