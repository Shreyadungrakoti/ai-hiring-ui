...
export default function Candidates() {
  ...
  const getScoreColor = (score) => {
    if (score >= 9) return "linear-gradient(135deg, #5F8EE8 0%, #7C8FE8 100%)"; // Blue with purple hint for top candidates (9+)
    if (score >= 8) return "linear-gradient(135deg, #5084E8 0%, #6B8FE8 100%)"; // Blue gradient for 8
    if (score >= 7) return "linear-gradient(135deg, #4A7FE0 0%, #6B8FE8 100%)"; // Blue gradient for 7
                  ...
                  <tr key={c.id} className={selectedCandidate?.id === c.id ? "candidateRowActive" : ""}>
                    ...
                    <td className="right" style={{ verticalAlign: "middle" }}>
                      {c.inmail_sent ? (
                        <span className="pill" style={{ 
                          background: "linear-gradient(135deg, #5F8EE8 0%, #7C8FE8 100%)", 
                          color: "#ffffff", 
                          border: "none",
                    ...
                    <td className="right" style={{ verticalAlign: "middle" }}>
                      {calledCandidates[c.id] ? (
                        <span className="pill" style={{ 
                          background: "linear-gradient(135deg, #4A7FE0 0%, #6B8FE8 100%)", 
                          color: "#ffffff", 
                          border: "none",
                          boxShadow: "0 2px 8px rgba(0, 0, 0, 0.2)"
                        }}>
